	...
	<div class="grid grid-cols-1 grid-rows-1">
		{#if activeService === 'Development'}
			<div class="col-start-1 row-start-1">
				<div
					...
					<div class="py-14 grid gap-4 justify-items-start">
						...
						<p>Custom‑built websites that are fast, secure, and designed to grow with your business.</p>
            ...
            <Checkmark body="Grow without limits thanks to scalable builds" />
						<Button classes="mt-4" type="link" link="/web-development">Let’s Build Something Powerful</Button>
					</div>
		...
		{#if activeService === 'Design'}
            ...
            <p>Beautiful, intuitive designs crafted to engage users and drive measurable business results</p>
		...
		{#if activeService === 'SEO'}
            ...
            <p>Get found by the right people with proven strategies that increase traffic and drive real business growth.</p>
		...
		{#if activeService === 'Web Audits'}
            ...
            <p>Uncover what’s holding your site back and get clear steps to boost speed, usability, and conversions.</p>
